type CreateTestStep = 1 | 2 | 3 | 4 | 5 | 6;
...
export function CreateTestStepper({
  ...
  customSteps?: Array<{ id: CreateTestStep; label: string }>;
}) {
      ...
      <div className="w-full">
        <div className="flex w-full items-start">
          {customSteps.map((step, index) => {
            ...
            return (
              <div key={step.id} className={`flex items-start ${index === customSteps.length - 1 ? "" : "flex-1"}`}>
